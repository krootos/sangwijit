...
function addJob()
{
    ...
    $technicianTel = $_POST['technicianTel'];
    ...
    $affiliation = $_POST['affiliation'];
      ...
      print_r($cusTel);echo"<br>";
      print_r($address);echo"<br>";
      print_r($district);echo"<br>";
      print_r($amphoe);echo"<br>";
      print_r($province);echo"<br>";
      print_r($zipcode);echo"<br>";
      print_r($latitude);echo"<br>";
      print_r($longtitude);echo"<br>";
    ...
    if (
        isset($jobNo) && !empty($jobNo)
        && isset($fname) && !empty($fname)
        && isset($lname) && !empty($lname)
        && isset($cusTel) && !empty($cusTel)
        ...
        && isset($longtitude) && !empty($longtitude)
        ) {
        ...
        // }
            ...
            $mysqli->query("INSERT INTO `testaddjob` (
                fname,
                lname,
                cusTel,
                address,
